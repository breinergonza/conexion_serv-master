...
public class LoginActivity extends AppCompatActivity {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                //Aquí creo que es donde se logea la cuestión...
                LoginUsuario(mEmail, mPassword);
    ...
    public void LoginUsuario(String Usuario, String Pass) {
        try {
            ...
            JSONObject params = new JSONObject("{correo: '"+ Usuario +"', password: '"+ Pass +"' }");

            FHCloudRequest request = FH.buildCloudRequest("login", "POST", null, params);
            request.executeAsync(new FHActCallback() {
                @Override
                public void success(FHResponse fhResponse) {
                    Log.d(TAG, "Llamada al Web Service - success");

                    if (fhResponse.getJson().toString().length() > 4){
                        resp = true;
                    }else{
                        resp = false;
                    }
                ...
                public void fail(FHResponse fhResponse) {
                    Log.d(TAG, "Llamada al Web Service - fail");
